Public Class VirtualSpaceForm
    ...
    Private Sub VirtualSpaceForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ' Initialize UI
    ...
    Private Sub spaceClient_MessageReceived(sender As Object, message As String) Handles spaceClient.MessageReceived
    ...
    Private Sub spaceClient_UserListUpdated(sender As Object, users As List(Of Object)) Handles spaceClient.UserListUpdated
        If InvokeRequired Then
    ...
    Private Sub spaceClient_ConnectionStatusChanged(sender As Object, isConnected As Boolean) Handles spaceClient.ConnectionStatusChanged
        If InvokeRequired Then
    ...
    Private Sub VirtualSpaceForm_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        spaceClient.Disconnect()
    End Sub
End Class
